...
DPQ_2005_2018 = rbind(DPQ_2005_2006, 
                      DPQ_2007_2008, 
                      DPQ_2009_2010, 
                      DPQ_2011_2012, 
                      DPQ_2013_2014, 
...
#write.csv(DPQ_2005_2018,"/Users/chenqiaochu/Desktop/625_project/DPQ_2005_2018/DPQ_2005_2018.csv", row.names = FALSE)
...
sum_fun = function(x){sum(x[2:11], na.rm = T)}
DPQ_2005_2018$sum_score = apply(DPQ_2005_2018, 1, sum_fun)
######## ######## ######## 

DPQ_2005_2018$dep_level = rep(0, nrow(DPQ_2005_2018))
DPQ_2005_2018$dep_level = ifelse(DPQ_2005_2018$sum_score <= 4, "mini", ifelse(DPQ_2005_2018$sum_score <= 9, "mild", ifelse(DPQ_2005_2018$sum_score <= 14, "moderate", ifelse(DPQ_2005_2018$sum_score <= 19, "moderate_severe", ifelse(DPQ_2005_2018$sum_score <= 27, "severe")))))
DPQ_2005_2018_w_level = select(DPQ_2005_2018, c(SEQN, sum_score, dep_level))

#write.csv(DPQ_2005_2018_w_level,"/Users/chenqiaochu/Desktop/625_project/DPQ_2005_2018/DPQ_2005_2018_w_level.csv", row.names = FALSE)
